...
class hF(tk.Frame):
    def __init__(self, parent, topOne):
        ...
        """
        self.aboutCode = tk.Label(self, text="Code Credits:", background=self.backgroundColor, fg=self.foregroundColor)
        ...
        self.helpLink = tk.Label(self, text="Help online")
        self.helpLink.bind('<Button-1>', lambda e: webbrowser.open_new(r"https://uflorida-my.sharepoint.com/:b:/g/personal/willdwat_ufl_edu/EVXPlDe9YS1KuvlLCePuQPMBqp5uJkS6vFUsUUUNvDDTkg?e=KSJj1k"))
        ...
        self.orazemEmail = tk.Label(self.aboutUsFrame, text="Email: morazem@ufl.edu", cursor ="hand2", bg=self.backgroundColor, fg=self.linkColor)
        self.orazemEmail.bind('<Button-1>', lambda e: webbrowser.open("mailto: morazem@ufl.edu"))
...
#        self.bugLink.configure(background=self.backgroundColor, cursor="hand2", fg=self.linkColor, font=("Arial", 16))
        ...
        """
        self.aboutCode.grid(column=0, row=1, sticky="W")
